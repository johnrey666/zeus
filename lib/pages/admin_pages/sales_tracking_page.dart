      ...
      body: _isLoading
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Monitor daily sales and revenue performance",
                  ...
                  Wrap(
                    ...
                    runSpacing: 16,
                    children: [
                      _buildStatCard("Today's Revenue", todaysRevenue,
                      ...
                      _buildStatCard("Member Sales", memberSales,
                          const Icon(Icons.person, color: Colors.black)),
                      _buildStatCard("Avg Sales Value", avgSalesValue,
                  ...
                  const Text("Latest transactions and sales activity",
